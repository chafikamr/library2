...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
	...
	<link rel="stylesheet" type="text/css" href="styles/style.css?version=51">
...
<body>
  ...
  <header>
    	...
    	<nav>
    		<h1>Library</h1>
    		<ul>
    			<li  <?php if(isset($page)&& $page==='home')echo 'class="active"'; ?>><a href="index.php"  style="color: white ; text-decoration: none;" >Home</a></li>
